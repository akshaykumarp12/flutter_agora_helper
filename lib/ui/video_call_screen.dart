...
class _VideoCallScreenState extends ConsumerState<VideoCallScreen> {
  ...
  Offset _localPreviewPosition = const Offset(20, 20);
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) {
        ...
        ref.read(remoteVideoStopped.notifier).state = false;
            ...
            children: [
              ...
              if (!widget.audioOnly) ...[
                Consumer(builder: (context, ref, child) {
                  ...
                  return Positioned(
                    left: _localPreviewPosition.dx,
                    top: _localPreviewPosition.dy,
                    child: GestureDetector(
                      onPanUpdate: (details) {
                        setState(() {
                          _localPreviewPosition += details.delta;
                        });
                      },
                      child: AnimatedContainer(
                        ...
                        width: size.width * (hideButtons ? 0.36 : 0.3),
                        child: AspectRatio(
                          aspectRatio: 9 / 16,
                          child: state
                              ? Container(
                ...
                if (!hideButtons)
                  Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () async =>
                          ref.read(videoCallController.notifier).switchCamera(),
                      child: Container(
